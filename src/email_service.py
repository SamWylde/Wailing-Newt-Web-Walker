...
SMTP_FROM = get_env('SMTP_FROM', 'noreply@wailingnewt.com')
SMTP_FROM_NAME = get_env('SMTP_FROM_NAME', 'Wailing Newt Web Walker')

# App URLs
MAIN_APP_URL = get_env('MAIN_APP_URL', 'https://wailingnewt.com/app')
WORKSHOP_APP_URL = get_env('WORKSHOP_APP_URL', 'https://wailingnewt.com/workshop')
